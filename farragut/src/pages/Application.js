          ...
          <Card className="application-card">
            <Card.Body>
              <Row>
                ...
                >
                  <button className="d-flex align-items-center justify-content-center btn edit-btn" to="/users">
                    Edit
                  </button>
                </Col>
              </Row>
              <Row className="application-card-content mt-1">
                <Col className="col-md-12">
                  ...
                  <p className="body-title">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form.</p>
                </Col>
              </Row>
            </Card.Body>
          </Card>
