...
const Application = () => {
  ...
  function handleEditShow(breakpoint) {
    setFullscreen(breakpoint);
    setEditShow(true);
  }
  return (
        ...
        <Row className="d-flex align-items-center mb-3">
          ...
          <Col className="col-md-6">
            <div className="justify-content-end d-flex align-items-center application-form">
              ...
              {/* Edit Model */}
                <Modal show={editShow} fullscreen={fullscreen} backdropClassName="fullscreen-modal-bg" className="model-component-wrapper" onHide={() => setEditShow(false)}>
                  ...
                  <Modal.Footer className="justify-content-start">
                    <Button variant="outline-danger" className="left-side left me-2 red-btn-outline" onClick={() => setEditShow(false)}>
                        Cancel<span class="bg" />
                      </Button>
                      <Button variant="danger" className="ms-2 red-btn">
                        Add
                      </Button>
